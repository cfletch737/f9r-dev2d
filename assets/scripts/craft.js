...
var Craft=function(options) {
  ...
  this.scenarios={
    ...
    "f9r-rtls": {
      position: [-275, 5000],
      velocity: [15,-500], //1150 for IRL, 240 for Sim
      engine_number:1,
    ...
    "f9r-rtls-extreme": {
      position: [-1400, 12000],
      velocity: [70,-1600], //1850 for IRL, 340 for Sim
      engine_number:1,
      ballast: 0,
      max_engines:3,
      angle: radians(8),
...
//    this.rocket_body.angularDamping=crange(0,this.getAltitude(),120000,d,0.01);
  ...
  this.updateAutopilot=function() {
    ...
    if(this.throttle < -0.0 && (this.getAltitude() > 2000 && this.engine_number == 3 && target_vspeed < 0)) {
      this.throttle = 0;
